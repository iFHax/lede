...
CONFIG_DEFAULT_ipq-wifi-arcadyan_aw1000=y
...
CONFIG_DEFAULT_nss-firmware-ipq8074=y
...
CONFIG_FEED_nas=y
CONFIG_FEED_nas_luci=y
CONFIG_FEED_modem_app=y
CONFIG_FEED_wwan=y
...
#
# CONFIG_PACKAGE_ipq-wifi-alibaba_ap4220 is not set
...
# CONFIG_PACKAGE_ipq-wifi-cmcc_rax3000q is not set
# CONFIG_PACKAGE_ipq-wifi-compex_wpq873 is not set
...
# CONFIG_PACKAGE_ipq-wifi-jdcloud_ax1800pro is not set
...
# CONFIG_PACKAGE_ipq-wifi-xiaomi_rm1800 is not set
# CONFIG_PACKAGE_ipq-wifi-yuncore_ax880 is not set
# CONFIG_PACKAGE_ipq-wifi-yuncore_fap650 is not set
...
# CONFIG_PACKAGE_en8811h-firmware is not set
...
# CONFIG_PACKAGE_nss-firmware-ipq5018 is not set
# CONFIG_PACKAGE_nss-firmware-ipq6018 is not set
...
# CONFIG_PACKAGE_kmod-mhi-pcie is not set
...
# CONFIG_NSS_DRV_EDMA_ENABLE is not set
...
# CONFIG_NSS_DRV_OVPN_ENABLE is not set
...
# CONFIG_PACKAGE_kmod-usb-net-gobinet is not set
...
# Wireless Drivers
#
# CONFIG_PACKAGE_kmod-aic8800s is not set
# CONFIG_PACKAGE_kmod-aic8800u is not set
...
# CONFIG_PACKAGE_kmod-rtl8821au is not set
...
# CONFIG_PACKAGE_libudebug is not set
...
# CONFIG_PACKAGE_luci-app-clouddrive2 is not set
...
# CONFIG_PACKAGE_luci-app-floatip is not set
...
CONFIG_PACKAGE_luci-app-ipinfo=y
# CONFIG_PACKAGE_luci-app-ipsec-vpnd is not set
# CONFIG_PACKAGE_luci-app-istoreenhance is not set
...
CONFIG_PACKAGE_luci-app-mttl=y
...
# CONFIG_PACKAGE_TURBOACC_INCLUDE_NO_FASTPATH is not set
...
# CONFIG_PACKAGE_luci-app-unishare is not set
...
# CONFIG_PACKAGE_luci-app-xupnpd is not set
# CONFIG_PACKAGE_luci-app-zerotier is not set
# CONFIG_PACKAGE_luci-nginxer is not set
...
# CONFIG_PACKAGE_luci-lib-iform is not set
...
# CONFIG_PACKAGE_luci-i18n-3ginfo-lite-de is not set
# CONFIG_PACKAGE_luci-i18n-3ginfo-lite-it is not set
# CONFIG_PACKAGE_luci-i18n-3ginfo-lite-pl is not set
# CONFIG_PACKAGE_luci-i18n-3ginfo-lite-ru is not set
# CONFIG_PACKAGE_luci-i18n-3ginfo-lite-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-adblock-lt is not set
# CONFIG_PACKAGE_luci-i18n-adblock-mr is not set
# CONFIG_PACKAGE_luci-i18n-adblock-ms is not set
# CONFIG_PACKAGE_luci-i18n-adblock-nl is not set
...
# CONFIG_PACKAGE_luci-i18n-adblock-zh-cn is not set
# CONFIG_PACKAGE_luci-i18n-adblock-zh-tw is not set
# CONFIG_PACKAGE_luci-i18n-argon-config-zh-cn is not set
# CONFIG_PACKAGE_luci-i18n-atcommands-it is not set
# CONFIG_PACKAGE_luci-i18n-atcommands-pl is not set
# CONFIG_PACKAGE_luci-i18n-atcommands-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-filemanager-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-modemband-pl is not set
# CONFIG_PACKAGE_luci-i18n-modemband-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-opkg-lt is not set
...
# CONFIG_PACKAGE_luci-i18n-ramfree-zh-cn is not set
# CONFIG_PACKAGE_luci-i18n-sms-tool-js-pl is not set
# CONFIG_PACKAGE_luci-i18n-sms-tool-js-ru is not set
# CONFIG_PACKAGE_luci-i18n-sms-tool-js-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-sqm-lt is not set
# CONFIG_PACKAGE_luci-i18n-sqm-mr is not set
# CONFIG_PACKAGE_luci-i18n-sqm-ms is not set
# CONFIG_PACKAGE_luci-i18n-sqm-nl is not set
...
# CONFIG_PACKAGE_ffmpeg-remux is not set
...
# CONFIG_PACKAGE_floatip is not set
...
# CONFIG_PACKAGE_quickstart is not set
...
CONFIG_OVERRIDE_PKGS="fibocom-dial quectel-cm"
